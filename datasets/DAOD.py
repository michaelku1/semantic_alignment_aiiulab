...
#         },
#         'foggy_cityscapes': {
#             'train_img': root / 'cityscapes/leftImg8bit_foggy_0.005/train',
#             'train_anno': root / 'cityscapes/annotations/foggy_cityscapes_train_0.005.json',
#             'val_img': root / 'cityscapes/leftImg8bit_foggy_0.005/val',
#             'val_anno': root / 'cityscapes/annotations/foggy_cityscapes_val_0.005.json',
#         },
...
#         'cityscapes': {
#             'train_img': root / 'cityscapes/leftImg8bit/train',
#             'train_anno': root / 'cityscapes/annotations/train_cityscapes_500.json',
#             'val_img': root / 'cityscapes/leftImg8bit/val',
#             'val_anno': root / 'cityscapes/annotations/cityscapes_val.json',
#         },
#         'foggy_cityscapes': {
#             'train_img': root / 'cityscapes/leftImg8bit_foggy/train',
#             'train_anno': root / 'cityscapes/annotations/train_foggy_cityscapes_500.json',
#             'val_img': root / 'cityscapes/leftImg8bit_foggy/val',
#             'val_anno': root / 'cityscapes/annotations/val_foggy_cityscapes_100.json',
#         },
...
class DADataset(Dataset):
    ...
    # NOTE: nominal batch size is batch_size//2, but since here we take two images from two different datasets,
    # the actual batch size is still batch_size
    def __getitem__(self, idx):
        # print(idx[0])
        # print(len(self.source))

        # BUG temporary workaround for jupyter debugging
        if type(idx) == list():
            idx = idx[0]
