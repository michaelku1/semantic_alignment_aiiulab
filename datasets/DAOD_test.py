...
# DADataset is a wrapper to call cocodetection for both source and target
...
def collate_fn(batch):
    ...
    # print(len(source_imgs + target_imgs))
    # quit()
    samples = nested_tensor_from_tensor_list(source_imgs + target_imgs)
    # print(samples.tensors.shape[0])
    ...
    # return samples, source_targets, target_targets
