...
_C.MODEL.VISUAL_PROMPT.SWITCH = False
...
_C.MODEL.VISUAL_PROMPT.DROP_NUM_LOW_CONF = 0
_C.MODEL.VISUAL_PROMPT.DROP_PROMPT_OUTPUTS = False
...
_C.PLOT.PLOT_PROMPT_BBOX = False
